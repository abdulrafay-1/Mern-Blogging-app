...
const Home = () => {
    ...
    const { user, setUser, setBlogs, blogs } = useUser();
        ...
        <div className="min-h-screen bg-gray-100 py-8 px-4">
            ...
            <div className="max-w-3xl mx-auto bg-white p-6 rounded-lg shadow-md">
                ...
                <form onSubmit={addPost} className="space-y-4">
                    ...
                    <button type="submit" className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-600 transition">Add Post</button>
                </form>
            </div>
                    ...
                    {blogs?.map((blog) => (
                        <div key={blog._id} className="bg-white p-6 rounded-lg shadow-md">
                            ...
                            <form onSubmit={(e) => addComment(e, blog._id)} className="flex items-center mt-4 space-x-2">
                                ...
                                <button type="submit" className="bg-green-500 text-white px-4 py-2 rounded-md hover:bg-green-600">Add</button>
                            </form>
                            <div className="mt-4">
